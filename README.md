...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/assert-is-nonpositive-finite/tags). For example,

```javascript
isNonPositiveFinite = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-nonpositive-finite@v0.1.2-umd/browser.js' )
```
...
[@stdlib/assert/is-nonpositive-number]: https://github.com/stdlib-js/assert-is-nonpositive-number/tree/umd
